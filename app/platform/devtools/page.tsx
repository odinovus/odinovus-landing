...
const features = [
  {
    title: "APIs & SDKs",
    desc: "Integrate quickly with pre-built tools and SDKs.",
  },
  {
    title: "Documentation",
    desc: "Comprehensive guides and examples for developers.",
  },
  { title: "Sandbox Environment", desc: "Test your integrations safely." },
];
  ...
  return (
    <main className="min-h-screen bg-[#0B0F1A] text-white pt-24">
      <section className="py-16 text-center">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-3 text-zinc-400 max-w-2xl mx-auto">
            APIs & SDKs for fast integration.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#070A12] text-center">
        <h2 className="text-3xl font-bold mb-4">Developer Ready</h2>
        <p className="text-zinc-400 mb-6">
          Start integrating Odinovus tools today.
        </p>
        <Link
          href="#"
