...
const features = [
  {
    ...
    desc: "Agents perform real-world tasks automatically.",
  },
  {
    title: "Scheduling & Triggers",
    desc: "Automate tasks based on events or schedules.",
  },
  {
    title: "AI Insights",
    desc: "Intelligent recommendations and decision support.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#0B0F1A] text-white pt-24">
      <section className="py-16 text-center">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-3 text-zinc-400 max-w-2xl mx-auto">
            Intelligent autonomous agents for real-world tasks.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#070A12] text-center">
        <h2 className="text-3xl font-bold mb-4">Deploy AI Agents</h2>
        <p className="text-zinc-400 mb-6">
          Automate tasks and make your systems smarter today.
        </p>
        <Link
          href="#"
