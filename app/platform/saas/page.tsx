...
const features = [
  {
    ...
    desc: "Deploy microservices with ease and scale automatically.",
  },
  {
    title: "User Management",
    desc: "Add, remove, and manage users seamlessly.",
  },
  {
    title: "Analytics Dashboard",
    desc: "Monitor key metrics and system performance in real-time.",
  },
  {
    title: "API Access",
    desc: "Integrate with other apps via REST & GraphQL APIs.",
  },
];
    ...
    <main className="min-h-screen bg-[#0B0F1A] text-white pt-24">
      <section className="py-16 text-center">
        <div className="mx-auto max-w-7xl px-6">
          <h1 className="text-4xl font-bold">SaaS Platform</h1>
          <p className="mt-3 text-zinc-400 max-w-2xl mx-auto">
            Build and deploy scalable SaaS solutions for your organization.
          </p>
        </div>
      </section>

      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2 lg:gap-10">
          {features.map((f, i) => (
            <article
              key={i}
      ...
      <section className="py-16 bg-[#070A12] text-center">
        ...
        <p className="text-zinc-400 mb-6">
          Start building your SaaS app today and scale with Odinovus.
        </p>
        <Link
          href="#"
